<?php namespace App\Http\Controllers;
	...
	class AdminDisposisiGeledahController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'User','name'=>'id_user','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'cms_users,id'];
	    ...
	    */
	    ...
	    public function getCetak($id){
			$data['disposisigeledah'] = DB::table('disposisi_geledah')
						// ->join('suplier', 'transaksipembelian.suplier', '=', 'suplier.id')
						->where('disposisi_geledah.id',$id)
						->get();
			 $data['disposisigeledah'] = DB::table('disposisi_geledah')
			 			->where('disposisi_geledah.id',$id)
						->get();
			...
			return $pdf->stream('laporandatausulan-pdf.pdf');
