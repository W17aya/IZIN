<?php namespace App\Http\Controllers;
	...
	class AdminSita45Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Jenis Surat','name'=>'jenis_surat','type'=>'select2','validation'=>'required','width'=>'col-sm-9','dataenum'=>'IZIN PENYITAAN;PERSETUJUAN PENYITAAN'];
			...
			$this->form[] = ['label'=>'Tanggal lahir','name'=>'tgl_lahir','type'=>'date','validation'=>'required','width'=>'col-sm-9'];
			...
			$this->form[] = ['label'=>'Surat permohonan Sita','name'=>'file_1','type'=>'upload','validation'=>'required','width'=>'col-sm-9'];
			...
			$this->form[] = ['label'=>'surat perintah Sita','name'=>'file_4','type'=>'upload','validation'=>'required','width'=>'col-sm-9'];
			...
			//$this->form[] = ['label'=>'Instansi','name'=>'id_penyidik','type'=>'hidden','validation'=>'required','width'=>'col-sm-9','value'=>CRUDBooster::myId()];
			//$this->form[] = ['label'=>'Tgl Surat','name'=>'tgl_surat','type'=>'date','validation'=>'required','width'=>'col-sm-9'];
			//$this->form[] = ['label'=>'Jenis Surat','name'=>'jenis_surat','type'=>'select2','validation'=>'required','width'=>'col-sm-9','dataenum'=>'IZIN PENGSitaAN;PERSETUJUAN PENGSitaAN;PENOLAKAN IZIN PENGSitaAN'];
			//$this->form[] = ['label'=>'Nama','name'=>'nama','type'=>'text','validation'=>'required','width'=>'col-sm-9'];
			//$this->form[] = ['label'=>'Tempat Lahir','name'=>'tempat_lahir','type'=>'text','validation'=>'required','width'=>'col-sm-9'];
	    ...
	    */
	    public function hook_after_add($id) {     
			$config{'content'} = "ada permohonan sita masuk ";
			$config['to'] = CRUDBooster::adminPath('sita46');
