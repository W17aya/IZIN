<?php namespace App\Http\Controllers;
	...
	class AdminTbInstansi17Controller extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		$this->col[] = array("label"=>"Website","name"=>"website" );
		$this->col[] = array("label"=>"Email","name"=>"email" );
		$this->col[] = array("label"=>"Logo","name"=>"logo" );
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:tb_instansi','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:tb_instansi","placeholder"=>"Please enter a valid email address"];
