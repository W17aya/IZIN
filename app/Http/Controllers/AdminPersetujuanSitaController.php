<?php namespace App\Http\Controllers;
	...
	class AdminPersetujuanSitaController extends \crocodicstudio\crudbooster\controllers\CBController {
	...
	// 					->get();
			...
			return $pdf->stream('Persetujuan Sita.pdf');
