<?php namespace App\Http\Controllers;
	...
	class AdminDisposisiPenahanan40Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "disposisi_penahanan";
			...
			$this->form = [];
			$this->form[] = ['label'=>'Id Surat','name'=>'id','type'=>'datamodal','validation'=>'required|required','width'=>'col-sm-10','datamodal_table'=>'penahanan','datamodal_columns'=>'id,no_surat,tgl_surat,pemohon','datamodal_columns_alias'=>'id,No surat,Tanggal surat, Asal surat','datamodal_select_to'=>'pemohon:pemohon,tgl_surat:tgl_surat,no_surat:id_surat'];
