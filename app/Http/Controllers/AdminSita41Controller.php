<?php namespace App\Http\Controllers;
	...
	class AdminSita41Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
            $this->form[] = ['label'=>'ID','name'=>'id','type'=>'datamodal','validation'=>'required|required','width'=>'col-sm-10','datamodal_table'=>'sita','datamodal_columns'=>'id,no_surat,tgl_surat,pemohon,jenis_surat,','datamodal_select_to'=>'ID:id,pemohon:pemohon,jenis_surat:jenis_surat,tgl_surat:tgl_surat,no_surat:no_surat_permohonan,nama:nama,umur:umur,pekerjaan:pekerjaan,agama:agama,jenis_kelamin:jenis_kelamin,kebangsaan:kebangsaan,tempat_tinggal:tempat_tinggal,tgl_lahir:umur,tempat_lahir:tempat_lahir'];			$this->form[] = ['label'=>'No Surat','name'=>'no_surat_permohonan','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
	...
	// 					->get();
			$pdf = PDF::loadView('penyitaankhusus',$data)
						->setPaper('a4', 'potrait');
			  
						  
			return $pdf->stream('Penyitaan khusus.pdf');
