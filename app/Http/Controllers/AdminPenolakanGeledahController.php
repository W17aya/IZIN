<?php namespace App\Http\Controllers;
	...
	class AdminPenolakanGeledahController extends \crocodicstudio\crudbooster\controllers\CBController {
	...
	// 					->get();
			$pdf = PDF::loadView('penolakangeledah',$data)
						->setPaper('a4', 'potrait');
			  
						  
			return $pdf->stream('Penolakan Geledah.pdf');
