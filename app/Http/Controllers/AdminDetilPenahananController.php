<?php namespace App\Http\Controllers;
	...
	class AdminDetilPenahananController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'ID','name'=>'id','type'=>'datamodal','validation'=>'required|required','width'=>'col-sm-10','datamodal_table'=>'penahanan','datamodal_columns'=>'id,no_surat,tgl_surat,pemohon,jenis_surat,','datamodal_columns_alias'=>'No surat,Tanggal surat, Asal surat,Jenis surat','datamodal_select_to'=>'ID:id,pemohon:pemohon,jenis_surat:jenis_surat,tgl_surat:tgl_surat,no_surat:no_surat_permohonan'];
			...
			$this->form[] = ['label'=>'Agama','name'=>'agama','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'ISLAM;KRISTEN;KATOLIK;HINDU;BUDHA;KONGHUCU'];
