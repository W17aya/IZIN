...
<head>
	<meta charset="UTF-8">
	<title>Permohonan Izin Online </title>
...
<header>
	...
	<div class="menu">
		<ul>
			...
			<li class="menu-item hidden"><a href="http://www.pn-banjarbaru.go.id/">Home</a></li>
		</ul>
	</div>

	<div class="heroe">

		<h1>Selamat Datang di Website Permohonan Izin Online</h1>
...
<footer>
	...
	<div class="copyrights">
		...
		<p>&copy; <?= date('Y') ?> Pengadilan Negeri Banjarbaru. copyrights ekowijayawindows@gmail.com</p>
